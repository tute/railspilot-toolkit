...
- **JIRA_SITE**: Resolve from `acli jira auth status` (the site name, e.g. `medu-dev`)
...
2. Family Reminders:
   - If title contains 'Jose' (case-insensitive) -> priority = 'low', low_priority_reason = 'Family reminder'
